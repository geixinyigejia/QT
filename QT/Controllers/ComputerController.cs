...
namespace GetLBAMVC.Controllers
{
    public class ComputerController : Controller
    {
        ...
        {
            List<PublishTasks> PublishedTasksByMe = GetAllPublishTasksByComputer();
        ...
        private List<PublishTasks> GetAllPublishTasksByComputer()
        {
            ...
            string sqlCommand = string.Format(@"use {0}; select * from publishTasks where TaskType=N'{1}'  and IsDeleted=0 and ReceiverName='' order by PublishTime DESC ", DBName, GetLBAMVC.Models.commonContext.TaskType.电脑);
